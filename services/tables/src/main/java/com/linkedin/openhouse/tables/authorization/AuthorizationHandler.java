...
/**
 * OpenHouse table sharing specification divides table-level access control into two parts: - Data
 * ACLs: These are used to control access to the data files that are part of the table. OpenHouse
 * delegates the enforcement of these ACLs to the underlying storage system. - Metadata RBAC: These
 * are used to control access to the metadata of the table, and enforced by Catalog service.
 *
