...
public final class TestHtsApiConstants {
  ...
  /**
   * The neutral read always names a canonical, non-null type; the routing tests use this to prove
   * the neutral route is wired to its own handler method rather than to the table one.
   */
