...
echo -e "  import org.apache.iceberg._"
echo -e "  import org.apache.iceberg.catalog._"
echo -e "  import org.apache.iceberg.types.Types._"
echo -e "  import org.apache.iceberg.data._"
echo -e "  import org.apache.iceberg.spark._"
echo -e "  import com.linkedin.openhouse.spark.OpenHouseSparkUtils"
echo ""

echo -e "${YELLOW}3. Common Types & Accessors:${NC}"
echo -e "  val catalog = spark.sessionState.catalogManager.catalog(\"openhouse\").asInstanceOf[org.apache.iceberg.spark.SparkCatalog]"
