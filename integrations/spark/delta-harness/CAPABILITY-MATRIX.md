# Delta harness planned capability matrix
...
This file records the planned full stack and its validated branch results. See
[TEST-COVERAGE.md](TEST-COVERAGE.md) for the description that grows with the
executable catalog on each branch.
