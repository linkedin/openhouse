...
private[integrationtests] final class GeneratedTableLockClient(tableApi: TableApi) extends TableLockClient {
...
private[integrationtests] object GeneratedTableLockClient {
