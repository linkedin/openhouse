...
public final class DataCompactionConfig {
  ...
  public static final double MIN_BYTE_SIZE_RATIO_DEFAULT =
      SizeBasedFileRewriter.MIN_FILE_SIZE_DEFAULT_RATIO;
  public static final double MAX_BYTE_SIZE_RATIO_DEFAULT =
      SizeBasedFileRewriter.MAX_FILE_SIZE_DEFAULT_RATIO;
  public static final int MIN_INPUT_FILES_DEFAULT = SizeBasedFileRewriter.MIN_INPUT_FILES_DEFAULT;
