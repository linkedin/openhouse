...
@SpringBootTest(
    ...
    properties = {
      ...
      "cluster.optimizer.database.url=jdbc:h2:mem:analyzer_config;MODE=MySQL;DB_CLOSE_DELAY=-1",
...
class AnalyzerDatabaseConfigurationTest {

  @Autowired ApplicationContext context;
  @Autowired TableStatsRepository repository;
  @MockBean AnalyzerRunner runner;
  @MockBean CadenceBasedOrphanFilesDeletionAnalyzer operationAnalyzer;
  ...
  void wiresOptimizerDataSourceWithoutImportingRestService() {
    ...
    assertThat(dataSource.getJdbcUrl())
        .isEqualTo("jdbc:h2:mem:analyzer_config;MODE=MySQL;DB_CLOSE_DELAY=-1");
